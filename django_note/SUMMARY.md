...
* 九、详情与分页
  ...
  * 9.1图书详情
    * [9.1.1图书详情页的展示](./09/9.1.1.md)
  * 9.2 详情页面编辑
    * [9.2.1图书详情页的编辑](./09/9.2.1.md)
  * 9.3 图片上传
    * [9.3.1图书封面图片的上传](./09/9.3.1.md)
  * 9.4图书分页
    * [9.4.1图书信息的分页展示](./09/9.4.1.md)

* 十、djangorestframework 框架

  * 10.1 DRF框架的介绍
    * [10.1.1什么是DRF以及作用](./10/10.1.1.md)
    * [10.1.2 DRF与django的关系](./10/10.1.2.md)
    * [10.1.3 CBV开发](./10/10.1.3.md)
  * 10.2 APIView
    * [10.2.1 APIView介绍以及使用](./10/10.2.1.md)
    * [10.2.2 APIView拓展](./10/10.2.2.md)
  * 10.3  Response
    * [10.3.1 了解DRFResponse，与django的区别](./10/10.3.1.md)
    * [10.3.2 使用DRFResponse](./10/10.3.2.md)
  * 10.4  request
    * [10.4.1 了解DRFRequest，与django的区别](./10/10.4.1.md)
    * [10.4.2  使用DRFRequest](./10/10.4.2.md)

* 十一、序列化Seriliazer

  * 11.1  序列化字段与类型
    * [11.1.1:理解序列化器](./11/11.1.1.md)
    * [11.1.2:序列化器演示](./11/11.1.2.md)
    * [11.1.3:序列化器使用](./11/11.1.3.md)
  * 11.2  序列化一对多外键
    * [11.2.1:使用一对多序列化器](./11/11.2.1.md)
    * [11.2.2:比较与非关系序列化器的区别](./11/11.2.2.md)
  * 11.3  反序列化器
    * [11.3.1 什么是反序列化](./11/11.3.1.md)
    * [11.3.2 反序列化器的使用](./11/11.3.2.md)
  * 11.4ModelSerialzer
    * [11.4.1 ModelSerialzer简介](./11/11.4.1.md)
    * [11.4.2 ModelSerialzer的使用](./11/11.4.2.md)

* 十二、反序列化

  * 12.1字段类型验证
    * [12.1.1反序列化器字段类型的介绍](./12/12.1.1.md)
    * [12.1.2反序列化器的字段类型的使用](./12/12.1.2.md)
  * 12.2 create()
    * [12.2.1 creater方法的意义以及作用](./12/12.2.1.md)
    * [12.2.2重写create方法以及使用](./12/12.2.2.md)
  * 12.3 update()方法
    * [12.3.1 update方法的意义以及作用](./12/12.3.1.md)
    * [12.3.2重写update方法以及使用](./12/12.3.2.md)
  * 12.4 is_valid() 异常抛出处理
    * [12.4.1	is_valid()的作用简介](./12/12.4.1.md)
    * [12.4.2	is_valid()的作使用](./12/12.4.2.md)
    * [12.4.3	is_valid()的拓展](./12/12.4.3.md)

* 十三、中间件与身份认证

  * 13.1 分页
    * [13.1.1后端分页接口](./13/13.1.1.md)
    * [13.1.2 Jquery分页](./13/13.1.2.md)
  * 13.2 中间件
    * [13.2.1 框架中间件](./13/13.2.1.md)
    * [13.2.2 自定义中间件](./13/13.2.2.md)
  * 13.3 登录装饰器
    * [13.3.1 登录装饰器](./13/13.3.1.md)
  * 13.4 身份认证
    * [13.4.1  生成令牌](./13/13.4.1.md)
    * [13.4.2 验证令牌](./13/13.4.2.md)

* 十四、异常与文件处理

  * 14.1 异常处理
    * [14.1.1 404 500异常页](./14/14.1.1.md)
    * [14.1.2 自定义异常处理](./14/14.1.2.md)
  * 14.2 生成接口文档
    * [14.2.1 生成drf接口文档](./14/14.2.1.md)
  * 14.3 文件上传
    * [14.3.1 axios上传文件](./14/14.3.1.md)
    * [14.3.2 drf处理文件](./14/14.3.2.md)
  * 14.4 文件下载
    * [14.4.1 文件下载](./14/14.4.1.md)
...
* 十七、多对多反序列化
  ...
  * 17.3 多对多反序列化案例
    * [17.3.1 多对多反序列化案例](./17/17.3.1.md)
  * 17.4 vue展示
    * [17.4.1 vue前端](./17/17.4.1.md)
    * [17.4.2 后端接口](./17/17.4.2.md)

* 十八、DRF框架及其使用

  * 18.1 限流
    * [18.1.1 了解限流](./18/18.1.1.md)
    * [18.1.2 限流的使用](./18/18.1.2.md)
  * 18.2 过滤
    * [18.2.1 了解过滤](./18/18.2.1.md)
    * [18.2.2 过滤的使用](./18/18.2.2.md)
  * 18.3 权限
    * [18.3.1 了解常见的权限管理](./18/18.3.1.md)
    * [18.3.2 权限的处理与使用](./18/18.3.2.md)
  * 18.4 版本及异常
    * [18.4.1 drf的版本](./18/18.4.1.md)
    * [18.4.2 drf 的异常](./18/18.4.2.md)